...
const homepage = {
  ...
  minutes: "MINUTES",
  seconds: "SECONDS",
  hackathonIntro: `The ETHTaipei hackathon is a three-day event inviting developers to compete for prizes sponsored by our generous supporters. Participants will collaborate in teams to develop innovative blockchain applications using Ethereum technologies. Attendance is free and includes workshops and talks from industry experts. Don't miss this chance to gain hands-on experience and connect with blockchain enthusiasts from Taiwan and beyond.`,
