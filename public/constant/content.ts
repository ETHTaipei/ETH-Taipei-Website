const common = {
  ...
  ethTaipeiIntro:
    ...
    "Welcome to the ETHTaipei 2024 event held in Taiwan. With a thriving Ethereum and developer community in Taiwan, ETHTaipei 2024 has brought together teams from around the world to participate in a 2-day conference focusing on the application and technology of Ethereum.",
  ethTaipeiIntro2:
